  ...
  return (
    <aside className="w-56 bg-white border-r border-gray-100 flex flex-col flex-shrink-0">
      <div className="px-4 py-5 border-b border-gray-50">
        ...
        <h1 className="text-lg font-bold tracking-tight text-gray-900">会议纪要</h1>
      </div>
                ...
                <div className="ml-3 mt-0.5 space-y-0.5">
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                      historySubTab === "meetings" ? "text-accent-700 bg-accent-50" : "text-gray-500 hover:bg-gray-50"
                    }`}
                  >
                    会议记录
                  </button>
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                      historySubTab === "week" ? "text-accent-700 bg-accent-50" : "text-gray-500 hover:bg-gray-50"
                    }`}
                  >
                    周报
                  </button>
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                      historySubTab === "month" ? "text-accent-700 bg-accent-50" : "text-gray-500 hover:bg-gray-50"
                    }`}
                  >
                    月报
                  </button>
