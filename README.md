...
智能会议助手与个人工作台。EaseWork 是一款面向职场人士的本地桌面应用，将会议管理、语音转写、日程规划和 AI 助手整合到一个无缝的工作流中。

与传统会议工具不同，EaseWork 注重**隐私优先**——音频处理和 AI 推理均在本地运行，数据不出设备。同时支持接入云端大模型以获得更强大的 AI 助手能力。
